...
use crate::modules::core_engine::ProcessingMetrics;
use anyhow::Result;
...
impl SemanticMetrics {
    ...
    pub async fn record_analysis(
        ...
        debug!(
            ...
            processing_metrics.total_time_ms
        );
    }
    ...
    async fn update_aggregated_stats(&self, record: &AnalysisRecord) {
        ...
        stats.total_processing_time_ms += record.processing_metrics.total_time_ms;
    ...
    async fn update_performance_tracking(&self, record: &AnalysisRecord) {
        ...
        performance.processing_times.push(record.processing_metrics.total_time_ms);
        
        // Keep processing times window for percentile calculations
        performance.recent_performance_window.push_back(record.processing_metrics.total_time_ms);
        ...
        let throughput_point = ThroughputPoint {
            ...
            analyses_per_second: record.processing_metrics.throughput_analyses_per_second,
